...
<figure>
<img width="140" src=".gitbook/2022-spring-assets/NabilahMuallifah_1/00.jpg"><figcaption align = "center"><i>Figure 2: Examples of saliency map based on importance or contribution of each pixel.</i>
</figcaption>
</figure>
...
1. Generating input explanations  
   ...
   <figure>
   <img width="140" src=".gitbook/2022-spring-assets/NabilahMuallifah_1/eq1.jpg">
   </figure>
...
2. Training reconstructor networks  
   ...
   <figure>
   <img width="140" src=".gitbook/2022-spring-assets/NabilahMuallifah_1/eq2.jpg">
   </figure>
...
<figure>
<img width="140" src=".gitbook/2022-spring-assets/NabilahMuallifah_1/1.jpg"><figcaption align = "center"><i>Figure 3: Input, gradient, and reconstruction of an example MNIST image and adversarial examples crafted using the image. For each attack, adversarial example with 𝜖 = 0.1 is created.</i>
</figcaption>
</figure>
...
<figure>
<img width="140" src=".gitbook/2022-spring-assets/NabilahMuallifah_1/3.jpg"><figcaption align = "center"><i>Table 1: Comparison on adversarial detection accuracy of the proposed (Ko & Lim) and existing approaches. The best and the second best results are highlighted in boldface and underlined texts, espectively. All benchmarks are done on MNIST dataset.</i>
</figcaption>
</figure>
