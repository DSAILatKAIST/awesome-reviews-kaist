---
description: >-
  Liangye Chen et al. / Points as Queries- Weakly Semi-supervised Object
  Detection by Points / CVPR-2021
---
...
![](https://blog.kakaocdn.net/dn/lcDyE/btrDPAI9Ba0/xP7MKAkFCfostYZAXRX270/img.png)
...
> _객체 내 위치하고, 객체 클래스를 카테고리로 취급합니다._
...
*   **Effect of Point Encoder**
    ...
    ![table3](https://blog.kakaocdn.net/dn/brqM6A/btrDSxZUP4d/wdlNdwRk8ZXRLKb6XqkCm0/img.png)
...
*   **Effect of Student Model**
    ...
    ![table3](https://blog.kakaocdn.net/dn/yTlno/btrDTRKmoms/yJUlYidSZ15OudKSjLdIJK/img.png)
...
*   **Comparison with another single-level detector**
    ...
    <img src="https://blog.kakaocdn.net/dn/HhTMD/btrDSx6EUQx/acTTR3XXJyHpsOKrHm10X1/img.png" alt="" data-size="original">
...
*   **Effect of Point Location**
    ...
    <img src="https://blog.kakaocdn.net/dn/K3CJp/btrDPBJtOUN/gg7eiSJeiQUHm0YYHeoqCk/img.png" alt="" data-size="original">
...
*   **Absolute vs. Relative Regression**
    ...
    ![](https://blog.kakaocdn.net/dn/clbn55/btrDQfFF9Ow/ydTMXr0W9thG4MR4F4vkyk/img.png)
...
*   **Effect of Point Annotations**
    ...
    <img src="https://blog.kakaocdn.net/dn/ce2VK6/btrDQErQ023/aWdXLK0xFndNmPkDtk2OO1/img.png" alt="" data-size="original">
