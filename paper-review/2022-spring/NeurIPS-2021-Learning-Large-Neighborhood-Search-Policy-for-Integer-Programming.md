...
**Rewards** : ![](https://latex.codecogs.com/svg.image?r_t)(![](https://latex.codecogs.com/svg.image?s_t, a_t)) = \mu^T(x_t - x_{t+1})) objection value인 ![](https://latex.codecogs.com/svg.image?\mu^Tx)가 얼마나 변했는지에 대한 것입니다.
