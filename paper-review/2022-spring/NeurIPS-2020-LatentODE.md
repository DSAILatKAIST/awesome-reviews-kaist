...
\$$dh\_{t}/dt=f\_{\theta}(h(t),t) where h(t\_{0})=h\_{0}\$$
...
\$$h\_{0},...,h\_{N}=ODESolve(f\_{\theta},h\_{0},(t\_{0},...,t\_{N}))\$$
...
\$$h'\_{i}=ODESolve(f\_{\theta},h\_{i-1},(t\_{i-1},t\_{i}))\$$
...
\$$z\_{0}{\sim}p(z\_{0})\$$\$$z\_{0},...,z\_{N}=ODESolve(f\_{\theta},z\_{0},(t\_{0},...,t\_{N}))\$$\$$x\_{i}{\sim}p(x\_{i}|z\_{i})\$$\$$q(z\_{0}|{x\_{i},t\_{i\}})=N({\mu}\_{z0},{\sigma}\_{zo}) where {\mu}\_{z0},{\sigma}\_{zo}=g(ODERNN\_{\phi}({x\_{i},t\_{i\}}))\$$
